...
<script type='text/javascript'>
    ...
    <div class="left_content">
      ...
      <ul class="left_menu">
		<div class="mandm">
		<li class="even"><a>Contact Us</a></li>
		</div>
		<div class="org">
	...
	<!-- Mission and Vission -->
		...
		<div class="prod_box_big">
			...
			<div class="center_prod_box_big">
							...
							<div class="welcsub"><center><p>Mobile: +91-9415025365 <p></center></div>
			<div class='logreg'>
					<div class="loginb">
		  ...
		  <div class="prod_box_big">
			...
			<div class="center_prod_box_big">
				...
				<div class='developer'>
					<div class="loginc">
					<br><br>					
					<span class="blue">Abdus Samad</span>   
					<br><br><br><br><br>				
					<span class="blue">Shubhi Nehal</span> 
					<br><br><br><br><br>					
					<span class="blue">Ayushman Mohan</span> 					
				</div>
			  </div>
			   </div>
			<div class="bottom_prod_box_big"></div>
