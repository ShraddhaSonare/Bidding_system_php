			...
			<div class="details_big_box">
				...
				<?php
							...
							if($_SESSION['logged']=='notactive'||$_SESSION['logged']=='guest'){
								echo"<span class='blue'><p> Only those who have an activated account can access to this and participate. Please Log-In or Register</p></span>";
							}else{
							
							echo"</span>
								<br />
								&nbsp&nbsp Bids: <span class='blue'>";?><?php echo $noofbidders;?><?php echo"</span><br /><br />
								&nbsp&nbsp Highest Bid: <span class='blue'>Rs";?><?php echo $highbid;?><?php echo"</span><br /><br />
								...
								<?php echo'</span><br /><br />
									<form method = "post" action="bidconfirm.php?id='.$prodid.'" id="logins-form" class="logins-form">
										...
										&nbsp&nbsp <strong>Rs</strong><input type="text" name="bidamount">
